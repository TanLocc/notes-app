      ...
      steps {
          script{
            withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-credentail', accessKeyVariable: 'AWS_ACCESS_KEY_ID', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
                ...
                VPC_ID=getVpcId()
                ClusterControlPlaneSecurityGroup=getSecurityGroups()
                subnets=getSubnets()
                sh "echo ${VPC_ID}"
                ...
                sh(script:"""
                  ...
                  ClusterControlPlaneSecurityGroup=\'${ClusterControlPlaneSecurityGroup}\' ClusterName=capstone KeyName=micro Subnets=\'${subnets}\' \
